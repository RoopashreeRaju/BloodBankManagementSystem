...
public class AllHosDetails extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AllHosDetails frame = new AllHosDetails();
	...
	public AllHosDetails() {
		...
		JLabel lblNewLabel = new JLabel("All Hospital Details");
		lblNewLabel.setFont(new Font("Times New Roman", Font.BOLD, 30));
		lblNewLabel.setBounds(304, 10, 287, 63);
		contentPane.add(lblNewLabel);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(30, 84, 792, 332);
		...
		btnNewButton.setBounds(664, 432, 85, 33);
		...
		btnNewButton_1.setBounds(89, 432, 85, 33);
